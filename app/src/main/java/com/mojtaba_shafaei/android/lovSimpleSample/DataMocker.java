...
static io.reactivex.Observable<Lce<List<? extends Item>>> getError() {
return io.reactivex.Observable.just(Lce.error("Error Happened"));
}

static io.reactivex.Observable<Lce<List<? extends Item>>> getList(String query) {
...
static io.reactivex.Observable<Lce<List<? extends Item>>> getList() {
return Observable.fromIterable(items)
         .toList()
         .toObservable()
         .map(t -> Lce.<List<? extends Item>>data("", t))
